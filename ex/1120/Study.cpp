...
/* ¿¹¿ÜÃ³¸®¸¦ À§ÇÑ »ó¼Ó°ü°è¿¡¼­ÀÇ ¿¹¿ÜÀ§ÀÓ¿¡ µû¸¥ ÁÖÀÇ»çÇ× */
class AAA
{
public:
	void ShowYou()
...
//		throw (AccountException)	// ¹®¹ý, °¡µ¶¼ºÀ» À§ÇØ »ç¿ëÇÔ
//	{
//		if (money < 0)
//		{
